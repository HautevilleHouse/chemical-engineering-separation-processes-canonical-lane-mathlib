...
def mathlibProofObligation : MathlibProofObligation := {
  sourceKey := "chemical-engineering-separation-processes-canonical-lane",
  theoremObject := "Chemical Engineering Separation Processes Endgame",
...
def theoremSpecificEndgamePilotClosed : Prop :=
  forall A : AdmissibleClass, ConstrainedSeparationClosure A

theorem theorem_specific_endgame_pilot_checked :
    theoremSpecificEndgamePilotClosed := by
  intro A
  exact constrained_separation_endgame A
